            ...
            <div className="overflow-y-auto custom-scrollbar px-6 sm:px-8 pb-8 -mt-12 relative z-10">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-slate-300 text-[11px] sm:text-xs leading-relaxed mb-5 max-w-[280px] mx-auto">
                  شغوف ببناء تجارب رقمية استثنائية تجمع بين الأداء العالي
                  والتصميم العصري. متخصص في تطوير المتاجر الإلكترونية الفاخرة.
                </p>
                ...
                <div className="flex flex-wrap justify-center gap-1.5 mb-5">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex items-center gap-1 px-2 py-0.5 bg-white/5 border border-solar/10 rounded-lg text-[9px] font-bold text-slate-200 hover:bg-solar/10 hover:border-solar/30 transition-colors cursor-default"
                    >

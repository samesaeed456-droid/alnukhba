                ...
                {cart.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-slate-400">
                    ...
                    <p className="text-sm sm:text-base text-center max-w-[250px] text-slate-500 mb-8">
                      يبدو أنك لم تضف أي منتجات إلى سلتك حتى الآن. اكتشف أحدث
                      ...
                      <div className="flex-1 flex flex-col justify-between py-0.5 sm:py-1">
                        <div>
                          <div className="flex justify-between items-start gap-2">
                            <h4 className="font-bold text-slate-800 line-clamp-2 text-xs sm:text-sm leading-tight">
                          ...
                          <div className="text-slate-900 font-bold mt-1 sm:mt-2 text-sm sm:text-base">
              ...
              {cart.length > 0 && (
                <div className="pt-4 sm:pt-6 mt-4 sm:mt-6 border-t border-slate-200 bg-white">
                  ...
                  <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                    ...
                    <div className="flex justify-between text-slate-500 text-xs sm:text-sm font-medium">
                      <span>التوصيل</span>
                      <span className="text-slate-800">يتم حسابه لاحقاً</span>
                    </div>
                  ...
                  <button
                    ...
                    className="w-full bg-solar hover:bg-solar/90 text-white py-3 sm:py-4 rounded-lg font-bold text-base sm:text-lg transition-colors flex items-center justify-center gap-2"
                  >
                    إتمام الطلب
                  </button>
                </div>

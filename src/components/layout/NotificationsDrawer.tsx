...
export default function NotificationsDrawer() {
  ...
  // Automatically mark all notifications as read when the drawer is opened
  useEffect(() => {
  ...
  }, [isNotificationsOpen, notifications, markNotificationAsRead]);
                          ...
                          <div className="flex gap-4">
                            ...
                            >
                              {notification.image ? (
                                ...
                                <img
                                  src={
                                    getProductImage(notification.productId) ||
                                    undefined
                                  }
                                  alt=""
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between gap-2 mb-1">
                                <h4
                                  className={`text-xs font-black truncate ${notification.isRead ? "text-slate-500" : "text-slate-900"}`}
                                >
                                  {notification.title}
                                </h4>
                              ...
                              <p
                                className={`text-[11px] leading-relaxed mb-3 line-clamp-2 ${notification.isRead ? "text-slate-400" : "text-slate-600"}`}
                              >

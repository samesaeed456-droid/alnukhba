...
export const loginWithEmail = withRetry((email: string, pass: string) =>
  signInWithEmailAndPassword(auth, email, pass),
);
export const signupWithEmail = withRetry((email: string, pass: string) =>
  createUserWithEmailAndPassword(auth, email, pass),
);
export const resetPassword = withRetry((email: string) =>
...
export const createAdminUserClientSide = async (
  email: string,
  pass: string,
) => {

...
export default function Contact() {
  ...
  const validate = () => {
    ...
    if (formData.message.length > MAX_MESSAGE_LENGTH)
      newErrors.message = "الرسالة طويلة جداً";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-1 space-y-4 order-2 lg:order-1">
            <div className="mb-4 sm:mb-6">
              <h2 className="text-lg sm:text-xl font-black text-carbon mb-1 sm:mb-2 text-center lg:text-right">
                معلومات التواصل
              </h2>
              <p className="text-xs sm:text-sm text-slate-500 font-medium text-center lg:text-right">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-4">
              {contactMethods.map((method, idx) => (
                ...
                >
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0 ${method.color}`}
                  >
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm font-black text-carbon group-hover:text-solar transition-colors truncate max-w-[150px] sm:max-w-none">
                      {method.value}
                    </p>
                  </div>
                </motion.a>
            ...
            <div className="p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-carbon text-white relative overflow-hidden mt-4">
              <div className="relative z-10">
                ...
                <p className="text-[10px] sm:text-xs text-slate-300 mb-4 leading-relaxed">
                  تواصل معنا عبر الواتساب للحصول على رد فوري خلال دقائق.
                </p>
                <a
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <div className="mb-6 sm:mb-8 text-center sm:text-right">
                    <h2 className="text-xl sm:text-2xl font-black text-carbon mb-1 sm:mb-2">
                      أرسل لنا رسالة
                    </h2>
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      />
                      <div
                        className={`absolute bottom-2 left-4 text-[9px] sm:text-[10px] font-bold ${formData.message.length >= MAX_MESSAGE_LENGTH ? "text-red-500" : "text-slate-400"}`}
                      >
                ...
                >
                  ...
                  <h2 className="text-xl sm:text-3xl font-black text-carbon mb-3 sm:mb-4">
                    تم إرسال رسالتك بنجاح!
                  </h2>
                  <p className="text-xs sm:text-base text-slate-500 font-medium mb-8 sm:mb-10 leading-relaxed max-w-md mx-auto px-2">
                    شكراً لتواصلك معنا. لقد استلمنا رسالتك وسيقوم فريق الدعم
                    الفني بالرد عليك في أقرب وقت ممكن عبر بريدك الإلكتروني أو
                    رقم الجوال.
                  </p>

    ...
    <div className="min-h-screen bg-bg-general py-8 sm:py-20 relative overflow-hidden">
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-10 sm:mb-16">
          ...
          <h1 className="text-2xl sm:text-5xl font-black text-carbon mb-2 sm:mb-4 tracking-tight">الأسئلة الشائعة</h1>
          ...
          {faqs.map((section, sIdx) => (
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8 pb-4 sm:pb-6 border-b border-bg-hover">
                ...
                <h2 className="text-lg sm:text-2xl font-black text-carbon">{section.category}</h2>
              </div>
                ...
                {section.questions.map((item, qIdx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span className={`font-bold text-xs sm:text-lg pr-2 transition-colors ${isOpen ? 'text-carbon' : 'text-slate-600'}`}>
                          {item.q}
                        </span>
                        <motion.div 
                          animate={{ 
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-xl sm:text-3xl font-black text-white mb-3 sm:mb-4">هل لديك سؤال آخر؟</h3>

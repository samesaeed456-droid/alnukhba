...
export default function Maintenance({ onBypass }: MaintenanceProps) {
  ...
  return (
    <div
      className="min-h-screen bg-carbon flex flex-col items-center justify-center p-6 text-center relative overflow-hidden"
      dir="rtl"
    >
      {/* Background Effects */}
      ...
      <div className="max-w-lg w-full bg-white/5 backdrop-blur-2xl rounded-[2rem] shadow-2xl p-6 sm:p-8 md:p-12 border border-white/10 relative z-10">
          ...
          <>
            ...
            <p className="text-gray-300 mb-10 leading-relaxed text-base sm:text-lg">
              {settings.maintenanceMessage ||
                "نعمل حالياً على تحسين تجربتك واللمسات النهائية على ميزات جديدة ستغير قواعد اللعبة. ترقبوا الإطلاق قريباً جداً."}
            </p>
            ...
            <form
              ...
              onSubmit={(e) => {
                e.preventDefault();
                toast.success(
                  "تم تسجيل رقمك بنجاح! سنرسل لك تنبيهاً فور الافتتاح.",
                );
              }}
            >
              ...
              <p className="text-xs text-gray-500 mt-3 font-medium">
                سجل الآن واحصل على خصم 20% عند الافتتاح!
              </p>
            </form>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex justify-center gap-4">
                  <a
                    ...
                    className="flex items-center gap-2 p-3 bg-white/5 rounded-xl text-gray-300 hover:text-white hover:bg-solar/20 border border-white/5 hover:border-solar/30 transition-all font-bold"
                  >
      ...
      <p className="mt-8 text-gray-500 text-sm relative z-10">
        &copy; {new Date().getFullYear()} {settings.storeName}. جميع الحقوق
        محفوظة.
      </p>
    </div>
  );

...
const privacySections = [
  {
    ...
    icon: Database,
    content:
      "نقوم بجمع المعلومات التي تقدمها لنا مباشرة عند إنشاء حساب أو إجراء عملية شراء، مثل الاسم، البريد الإلكتروني، رقم الهاتف، وعنوان التوصيل. كما نجمع بيانات تقنية حول جهازك وتفاعلك مع الموقع لتحسين الخدمة.",
  },
  {
    id: "2",
    ...
    icon: Eye,
    content:
      "نستخدم هذه المعلومات لمعالجة طلباتك، التواصل معك بشأن طلبك، وتحسين تجربة التسوق الخاصة بك. كما قد نستخدمها لإرسال عروض ترويجية مخصصة لك إذا وافقت على ذلك.",
  },
  {
    id: "3",
    ...
    icon: Lock,
    content:
      "نحن نطبق أعلى معايير الأمان العالمية للحفاظ على سلامة معلوماتك. يتم تشفير جميع البيانات الحساسة والمالية عبر تقنية SSL المتقدمة، ولا يتم تخزين بيانات البطاقات الائتمانية في خوادمنا.",
  },
  {
    id: "4",
    ...
    icon: Cookie,
    content:
      "نستخدم ملفات تعريف الارتباط لتحسين تجربتك، تذكر محتويات سلة التسوق، وفهم تفضيلاتك للزيارات المستقبلية. يمكنك التحكم في إعدادات ملفات تعريف الارتباط من متصفحك.",
  },
  {
    id: "5",
    ...
    icon: Share2,
    content:
      "نحن لا نبيع أو نتاجر بمعلوماتك الشخصية. نشارك فقط البيانات الضرورية مع شركاء موثوقين (مثل شركات الشحن) لإتمام طلبك، وبموجب اتفاقيات سرية صارمة.",
  },
];
    ...
    <div className="min-h-screen bg-bg-general py-8 sm:py-24 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mb-8 sm:mb-12">
          ...
          <div>
            <h1 className="text-xl sm:text-4xl font-black text-carbon">
              سياسة الخصوصية
            </h1>
            <p className="text-muted text-xs sm:text-sm font-medium mt-1">
              نحن نحمي خصوصيتك كأنها خصوصيتنا
            </p>
          </div>
        </div>
          ...
          {privacySections.map((section) => (
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                ...
                <h2 className="text-base sm:text-xl font-black text-carbon">
        ...
        <div className="mt-8 sm:mt-12 p-5 sm:p-8 bg-emerald-50 rounded-2xl sm:rounded-[2rem] border border-emerald-100 flex flex-col sm:flex-row items-start gap-4">
          ...
          <div className="text-center sm:text-right">
            <h4 className="font-black text-carbon mb-1 text-base sm:text-lg">
              التزامنا تجاهك
            </h4>
            <p className="text-muted text-xs sm:text-sm font-medium leading-relaxed">
              في متجر النخبة، نعتبر خصوصية بياناتك أولوية قصوى. نحن نلتزم بكافة
              القوانين واللوائح المحلية والدولية المتعلقة بحماية البيانات لضمان
              تجربة تسوق آمنة وموثوقة.
            </p>
          </div>
        </div>
      </motion.div>

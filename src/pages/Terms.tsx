...
const termSections = [
  {
    ...
    icon: Scale,
    content:
      "مرحباً بكم في متجر النخبة. باستخدامكم لهذا الموقع، فإنكم توافقون على الالتزام بالشروط والأحكام التالية. يرجى قراءتها بعناية قبل البدء في استخدام المتجر، حيث تعتبر هذه الشروط بمثابة عقد قانوني بينكم وبين المتجر.",
  },
  {
    id: "2",
    ...
    icon: UserCheck,
    content:
      "أنت مسؤول عن الحفاظ على سرية معلومات حسابك وكلمة المرور الخاصة بك. كما توافق على تحمل المسؤولية الكاملة عن جميع الأنشطة التي تحدث تحت حسابك، ويجب إبلاغنا فوراً في حال اشتباهك في أي اختراق أمني.",
  },
  {
    id: "3",
    ...
    icon: CreditCard,
    content:
      "نحن نسعى جاهدين لتقديم أدق المعلومات حول الأسعار. ومع ذلك، قد تحدث أخطاء تقنية. في حال وجود خطأ في سعر المنتج، نحتفظ بالحق في إلغاء الطلب أو التواصل معك لتصحيح السعر قبل الشحن.",
  },
  {
    id: "4",
    ...
    icon: Truck,
    content:
      "نحن نبذل قصارى جهدنا لتوصيل طلباتكم في أسرع وقت ممكن. تعتمد مدة التوصيل على موقعك الجغرافي. المتجر غير مسؤول عن التأخير الناتج عن شركات الشحن الخارجية أو الظروف القاهرة.",
  },
  {
    id: "5",
    ...
    icon: ShieldCheck,
    content:
      "جميع المحتويات الموجودة على الموقع من نصوص، صور، شعارات، وتصاميم هي ملكية حصرية لمتجر النخبة ومحمية بموجب قوانين الملكية الفكرية المعمول بها.",
  },
];
      ...
      >
        ...
        <div className="mt-8 sm:mt-12 p-6 sm:p-8 bg-carbon rounded-2xl sm:rounded-[2rem] text-center text-white relative overflow-hidden">
          ...
          <p className="text-white/70 text-sm sm:text-base font-medium mb-6">
            باستخدامك لمتجر النخبة، أنت توافق على جميع البنود المذكورة أعلاه.
          </p>
          <button
            onClick={() => navigate("/")}

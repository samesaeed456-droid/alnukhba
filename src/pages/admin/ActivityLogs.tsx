...
export default function ActivityLogs() {
  ...
  const getActionStyle = (action: string) => {
    if (action.includes("إضافة") || action.includes("إنشاء"))
      return {
                ...
                paginatedLogs.map((log) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg border ${style.bg} ${style.color} ${style.border} text-xs font-bold`}
                        >
                      ...
                      <td
                        className="px-6 py-4 text-xs text-gray-400 font-mono text-left"
                        dir="ltr"
                      >
                        {log.ip || "192.168.1.1"}
                      </td>
          ...
          {paginatedLogs.length > 0 ? (
            paginatedLogs.map((log) => {
              ...
              return (
                <div
                  key={log.id}
                  className="p-4 space-y-3 hover:bg-gray-50/50 transition-all"
                >

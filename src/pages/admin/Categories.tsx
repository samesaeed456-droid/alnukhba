...
export default function AdminCategories() {
  ...
  return (
    <div
      className="w-full bg-slate-50 min-h-screen relative font-sans pt-4 sm:pt-8"
      dir="rtl"
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
          {filteredCategories.map((category) => (
            <motion.div
              ...
              className="bg-white rounded-[2rem] p-5 shadow-sm border border-slate-100 group relative"
            >
              <div className="relative w-full h-32 mb-4 rounded-xl overflow-hidden bg-slate-50">
                ...
                <div
                  className={
                    "absolute top-2 right-2 px-2 py-1 rounded-lg text-[10px] font-bold " +
                    (category.isActive
              ...
              <h3 className="text-lg font-black text-carbon mb-2">
                {category.name}
              </h3>
              ...
              <div className="flex items-center gap-2 border-t border-slate-100 pt-4">
                <button
                  ...
                  className="flex-1 py-2 bg-slate-50 text-carbon hover:bg-slate-100 rounded-xl text-sm font-bold flex justify-center items-center gap-2 transition-colors"
                >
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-white w-full max-w-lg rounded-[2.5rem] p-6 shadow-2xl relative z-10"
            >
              <button
                onClick={() => setIsModalOpen(false)}
                className="absolute top-6 left-6 w-8 h-8 flex items-center justify-center bg-slate-100 text-slate-500 rounded-full hover:bg-slate-200 transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
              <h2 className="text-xl font-black text-carbon mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-solar transition-colors"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-500 mb-2">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-solar transition-colors resize-none"
                  />
                </div>
                <div
                ...
                <div className="pt-4 mt-6 border-t border-slate-100 flex justify-end gap-3">
                  ...
                  <button
                    type="submit"
                    className="px-6 py-3 rounded-xl font-bold bg-solar text-white hover:bg-solar/90 shadow-lg shadow-solar/20 hover:-translate-y-1 transition-all"
                  >

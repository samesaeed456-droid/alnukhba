    ...
    >
      ...
      <div className="px-2 sm:px-8 lg:px-12 mb-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-titanium/60 mt-1">تحكم شامل في منتجاتك، أسعارك، وحركة مخزونك بذكاء</p>
          </div>
        </div>
      ...
      <div className="px-2 sm:px-8 lg:px-12 mb-10">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          <motion.div
            ...
            className="bg-white p-4 sm:p-6 rounded-[2rem] shadow-sm border border-titanium/5 flex flex-col items-center sm:items-start text-center sm:text-right group hover:shadow-xl hover:shadow-carbon/5 transition-all duration-500 cursor-pointer"
          >
            <div className="flex justify-between items-start w-full mb-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-carbon text-solar flex items-center justify-center group-hover:scale-110 transition-transform duration-500 shadow-lg shadow-carbon/20">
                <Package className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>
              <div className="bg-carbon/5 text-titanium/60 px-2 py-1 rounded-full text-[8px] sm:text-[10px] font-black tracking-wider flex items-center gap-1">
                <span>الكل</span>
              </div>
            </div>
            <div className="w-full">
              <span className="text-titanium/60 text-[10px] sm:text-xs font-black uppercase tracking-widest block mb-1">إجمالي المنتجات</span>
          ...
          <motion.div
            ...
            className="bg-white p-4 sm:p-6 rounded-[2rem] shadow-sm border border-titanium/5 flex flex-col items-center sm:items-start text-center sm:text-right group hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-500 cursor-pointer"
          >
            <div className="flex justify-between items-start w-full mb-4">
            ...
            <div className="w-full">
              <span className="text-titanium/60 text-[10px] sm:text-xs font-black uppercase tracking-widest block mb-1">مخزون منخفض</span>
              <div className="flex items-baseline justify-center sm:justify-start gap-1">
                <span className="text-xl sm:text-2xl font-black text-carbon">{stats.lowStock}</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white p-4 sm:p-6 rounded-[2rem] shadow-sm border border-titanium/5 flex flex-col items-center sm:items-start text-center sm:text-right group hover:shadow-xl hover:shadow-red-500/10 transition-all duration-500 cursor-pointer"
          >
            <div className="flex justify-between items-start w-full mb-4">
            ...
            <div className="w-full">
              <span className="text-titanium/60 text-[10px] sm:text-xs font-black uppercase tracking-widest block mb-1">غير متوفرة</span>
              <div className="flex items-baseline justify-center sm:justify-start gap-1">
                <span className="text-xl sm:text-2xl font-black text-carbon">{stats.outOfStock}</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white p-4 sm:p-6 rounded-[2rem] shadow-sm border border-titanium/5 flex flex-col items-center sm:items-start text-center sm:text-right group hover:shadow-xl hover:shadow-green-500/10 transition-all duration-500"
          >
            <div className="flex justify-between items-start w-full mb-4">
            ...
            <div className="w-full">
              <span className="text-titanium/60 text-[10px] sm:text-xs font-black uppercase tracking-widest block mb-1">إجمالي المخزون</span>
              <div className="flex items-baseline justify-center sm:justify-start gap-1">
                <span className="text-xl sm:text-2xl font-black text-carbon">{formatPrice(stats.totalValue)}</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      >
            ...
            <div className="px-2 sm:px-8 lg:px-12 mb-6 sm:mb-8">
              <div className="bg-white p-4 sm:p-6 rounded-2xl sm:rounded-[32px] border border-titanium/5 shadow-sm space-y-4 sm:space-y-6">
                <div className="flex flex-col lg:flex-row gap-4">
                  <div className="relative flex-1 group">
                    <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-titanium/40 group-focus-within:text-solar transition-all duration-300" />
                    <input
                      type="text"
                      placeholder="البحث بالاسم، الفئة، أو العلامة التجارية..."
                      value={searchTerm}
                      onChange={(e) => setSearchTerm(e.target.value)}
                      className="w-full pl-10 sm:pl-12 pr-4 sm:pr-6 py-3 sm:py-4 rounded-xl sm:rounded-[20px] bg-carbon/5 border border-transparent focus:bg-white focus:ring-[6px] focus:ring-solar/5 focus:border-solar/30 outline-none transition-all duration-300 font-bold text-carbon placeholder:text-titanium/20 text-xs sm:text-sm"
                    />
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2 bg-carbon/5 p-1 sm:p-1.5 rounded-xl sm:rounded-2xl border border-titanium/5">
                      <button 
                        onClick={() => setViewMode('table')}
                        className={`p-2 sm:p-2.5 rounded-lg sm:rounded-xl transition-all ${viewMode === 'table' ? 'bg-white shadow-sm text-solar' : 'text-titanium/40 hover:text-carbon'}`}
                      >
                        <List className="w-4 h-4 sm:w-5 sm:h-5" />
                      </button>
                      <button 
                        onClick={() => setViewMode('grid')}
                        className={`p-2 sm:p-2.5 rounded-lg sm:rounded-xl transition-all ${viewMode === 'grid' ? 'bg-white shadow-sm text-solar' : 'text-titanium/40 hover:text-carbon'}`}
                      >
                    ...
                    <div className="relative group flex-1 sm:flex-none">
                      <Filter className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-3 h-3 sm:w-4 sm:h-4 text-titanium/40 pointer-events-none" />
                      <select 
                        value={categoryFilter}
                        onChange={(e) => setCategoryFilter(e.target.value)}
                        className="w-full sm:w-auto pl-8 sm:pl-10 pr-4 sm:pr-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl bg-carbon/5 border border-transparent hover:border-titanium/10 font-bold text-carbon outline-none focus:ring-4 focus:ring-solar/10 appearance-none transition-all cursor-pointer min-w-[100px] sm:min-w-[140px] text-[10px] sm:text-xs"
                      >
                        {filterCategories.map(cat => (
                          <option key={cat} value={cat}>{cat}</option>
                        ))}
                      </select>
                      <ChevronDown className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 w-3 h-3 sm:w-4 sm:h-4 text-titanium/40 pointer-events-none" />
                    </div>

                    <div className="relative group flex-1 sm:flex-none">
                      <ShieldCheck className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-3 h-3 sm:w-4 sm:h-4 text-titanium/40 pointer-events-none" />
                      <select 
                        value={stockFilter}
            ...
            <div className="px-2 sm:px-8 lg:px-12">
              {viewMode === 'table' ? (
                <div className="bg-white rounded-2xl sm:rounded-[32px] border border-titanium/5 shadow-sm overflow-hidden">
                  <div className="overflow-x-auto">
                    {/* Desktop Table */}
                    <table className="w-full text-right hidden md:table">
                      <thead>
                      <tr className="bg-carbon/5 text-titanium/60 text-[10px] uppercase tracking-[0.25em] border-b border-titanium/5">
                        <th className="p-8 w-12">
                          <input 
                            type="checkbox" 
                            checked={selectedProducts.length === filteredProducts.length && filteredProducts.length > 0}
                            onChange={toggleSelectAll}
                            className="w-5 h-5 rounded-lg border-titanium/20 text-solar focus:ring-solar/20 transition-all cursor-pointer bg-white"
                          />
                        </th>
                        ...
                        <AnimatePresence mode="popLayout">
                          {filteredProducts.map((product) => (
                            <motion.tr 
                              ...
                              animate={{ opacity: 1 }}
                              exit={{ opacity: 0 }}
                              className={`group hover:bg-carbon/5 transition-all ${selectedProducts.includes(product.id) ? 'bg-solar/5' : ''}`}
                            >
                              <td className="p-6">
                                <input 
                                  type="checkbox" 
                                  ...
                                  className="w-5 h-5 rounded-lg border-titanium/20 text-solar focus:ring-solar transition-all cursor-pointer"
                                />
                              </td>
                              <td className="p-6">
                                <div className="flex items-center gap-4">
                                  <div className="relative w-14 h-14 rounded-2xl overflow-hidden border border-titanium/5 group-hover:scale-105 transition-transform shadow-sm">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-[10px] text-titanium/40 font-bold uppercase tracking-widest">{product.brand}</p>
                                  </div>
                                </div>
                              </td>
                              <td className="p-6">
                                <span className="inline-flex items-center px-3 py-1 rounded-xl text-[10px] font-black bg-carbon/5 text-titanium/60 uppercase tracking-widest">
                                  {product.category}
                                </span>
                              </td>
                              <td className="p-6">
                                <div className="flex flex-col text-right">
                                  ...
                                  {product.originalPrice && (
                                    <span className="text-[10px] text-titanium/40 line-through font-bold">{formatPrice(product.originalPrice)}</span>
                                  )}
                                </div>
                              </td>
                              <td className="p-6">
                                <div className="flex flex-col gap-2 min-w-[120px]">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-[9px] text-titanium/40 font-bold">
                                      {Math.min(100, ((product.stockCount || 0) / 100) * 100).toFixed(0)}%
                                    </span>
                                  </div>
                                  <div className="h-1.5 w-full bg-carbon/5 rounded-full overflow-hidden">
                                    <motion.div 
                                      initial={{ width: 0 }}
                                  ...
                                  <input
                                    ...
                                    className={`w-20 px-3 py-2 rounded-xl border-2 font-mono text-center font-black focus:outline-none transition-all text-xs ${
                                      stockEdits[product.id] !== undefined
                                        ...
                                        : 'border-titanium/5 bg-carbon/5 text-titanium/60'
                                    }`}
                                  />
                                  {stockEdits[product.id] !== undefined && (
                                    <button 
                              ...
                              <td className="p-6">
                                <div className="flex items-center justify-center gap-2">
                                  ...
                                  <button 
                                    className="p-2.5 text-titanium/40 hover:bg-carbon/5 rounded-xl transition-all"
                                    title="عرض في المتجر"
                                  >
                    ...
                    <div className="md:hidden divide-y divide-titanium/5">
                      {filteredProducts.map((product) => (
                        <div key={product.id} className="p-4 flex flex-col gap-4">
                          <div className="flex items-center gap-4">
                            <input 
                              ...
                              checked={selectedProducts.includes(product.id)}
                              onChange={() => toggleSelectProduct(product.id)}
                              className="w-5 h-5 rounded-lg border-titanium/20 text-solar"
                            />
                            <img src={product.image || undefined} alt={product.name} className="w-12 h-12 rounded-xl object-cover border border-titanium/5" referrerPolicy="no-referrer" />
                            <div className="flex-1 min-w-0 text-right">
                              <p className="font-black text-carbon text-sm truncate">{product.name}</p>
                              <p className="text-[9px] text-titanium/40 font-bold uppercase tracking-widest">{product.brand}</p>
                            </div>
                            <div className="flex flex-col items-end">
                              {renderPrice(product.price, "font-black text-carbon text-sm")}
                              <span className="text-[9px] text-titanium/40 font-bold">{product.category}</span>
                            </div>
                          </div>
                          
                          <div className="flex items-center justify-between gap-4 bg-carbon/5 p-3 rounded-xl">
                            <div className="flex-1">
                              ...
                              <div className="h-1 w-full bg-carbon/10 rounded-full overflow-hidden">
                                <div 
                                  className={`h-full rounded-full ${
                                    (product.stockCount || 0) > (product.minStock || 5) ? 'bg-emerald-500' : 
                                    (product.stockCount || 0) > 0 ? 'bg-amber-500' : 'bg-red-500'
                              ...
                              <input
                                ...
                                className={`w-14 px-2 py-1.5 rounded-lg border text-center font-mono text-[10px] font-black focus:outline-none transition-all ${
                                  stockEdits[product.id] !== undefined
                                    ...
                                    : 'border-titanium/10 bg-white text-titanium/60'
                                }`}
                              />
                            </div>
                          </div>
                  ...
                  <AnimatePresence mode="popLayout">
                    {filteredProducts.map((product) => (
                      <motion.div
                        ...
                        className="bg-white rounded-2xl sm:rounded-[40px] border border-titanium/5 shadow-sm overflow-hidden group hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col"
                      >
                        <div className="relative aspect-[4/5] overflow-hidden">
                          ...
                          <div className="absolute top-3 sm:top-5 right-3 sm:right-5 flex flex-col gap-2 sm:gap-3 transition-all duration-500 opacity-0 group-hover:opacity-100 translate-x-10 group-hover:translate-x-0">
                            <button 
                              onClick={() => handleOpenModal(product)}
                              className="p-2 sm:p-3 bg-white text-solar rounded-xl sm:rounded-2xl shadow-xl hover:bg-solar hover:text-carbon transition-all active:scale-90"
                            >
                          ...
                          <div className="absolute bottom-3 sm:bottom-5 left-3 sm:left-5 right-3 sm:right-5 flex flex-col gap-2 sm:gap-3 translate-y-10 group-hover:translate-y-0 transition-transform duration-500">
                                ...
                                <div className="flex items-center gap-1">
                                  <input
                                    ...
                                    className={`w-10 sm:w-16 px-1 py-0.5 sm:px-2 sm:py-1 rounded-lg border text-center font-mono text-[8px] sm:text-[10px] font-black focus:outline-none transition-all ${
                                      stockEdits[product.id] !== undefined
                                        ? 'border-solar bg-solar/10 text-carbon'
                                        : 'border-transparent bg-carbon/5 text-titanium/60'
                                    }`}
                                  />
                                </div>
                              </div>
                              <div className="h-1 w-full bg-carbon/5 rounded-full overflow-hidden">
                                <div 
                            ...
                            <button className="w-full py-2 sm:py-3 bg-solar text-carbon rounded-xl sm:rounded-2xl font-black text-[8px] sm:text-[10px] uppercase tracking-widest shadow-gold active:scale-95 transition-all">
                              التفاصيل
                            </button>
                          </div>
                        </div>
                        <div className="p-3 sm:p-6 flex-1 flex flex-col text-right">
                          <div className="flex items-center justify-between mb-2 sm:mb-3">
                            <span className="text-[7px] sm:text-[9px] font-black uppercase tracking-widest text-titanium/40">{product.category}</span>
                            <div className="flex items-center gap-1 text-solar bg-solar/10 px-1.5 py-0.5 rounded-lg">
                          ...
                          <div className="mt-auto pt-3 sm:pt-4 flex items-center justify-between">
                            <div className="flex flex-col">
                              ...
                              {product.originalPrice && (
                                <span className="text-[8px] sm:text-[10px] text-titanium/40 line-through font-bold">{formatPrice(product.originalPrice)}</span>
                              )}
                            </div>
                            <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-carbon/5 flex items-center justify-center text-titanium/40 group-hover:bg-solar/10 group-hover:text-solar transition-all">
      ...
      {filteredProducts.length === 0 && (
        <div className="px-4 sm:px-8 lg:px-12">
          <div className="flex flex-col items-center justify-center py-24 bg-white rounded-[40px] border-2 border-dashed border-titanium/10">
            <div className="w-24 h-24 bg-carbon/5 rounded-full flex items-center justify-center mb-6 shadow-inner">
              <Package className="w-10 h-10 text-titanium/20" />
            </div>
            <h3 className="text-2xl font-black text-carbon">لا توجد منتجات</h3>
            <p className="text-titanium/40 mt-2 font-bold text-xs uppercase tracking-widest">جرب تغيير معايير البحث أو إضافة منتج جديد لمتجرك</p>
            <button 
              onClick={() => handleOpenModal()}
      ...
      <AnimatePresence>
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              {/* Modal Header */}
              <div className="flex items-center justify-between p-6 border-b border-titanium/5 bg-carbon/5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-solar shadow-sm border border-titanium/10">
                ...
                <button 
                  onClick={handleCloseModal}
                  className="p-2 hover:bg-carbon/10 rounded-xl transition-all text-titanium/40 hover:text-carbon"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  <div className="lg:col-span-4 space-y-6">
                    <div className="flex flex-col items-center gap-4">
                      <label className="flex flex-col items-center justify-center w-full aspect-square max-w-[280px] border-2 border-titanium/10 border-dashed rounded-3xl cursor-pointer bg-carbon/5 hover:bg-carbon/10 transition-all relative overflow-hidden group shadow-sm">
                        {formData.image ? (
                          <>
                          ...
                          <div className="flex flex-col items-center justify-center text-titanium/40">
                      ...
                      <div className="w-full">
                        <label className="block text-[11px] font-bold text-titanium/40 uppercase tracking-widest mb-3">معرض الصور</label>
                        <div className="grid grid-cols-3 gap-2">
                          {formData.images?.map((img, idx) => (
                            <div key={idx} className="relative aspect-square rounded-xl overflow-hidden border border-titanium/10 group">
                          ...
                          <label className="flex flex-col items-center justify-center aspect-square border-2 border-titanium/10 border-dashed rounded-xl cursor-pointer bg-carbon/5 hover:bg-carbon/10 transition-all text-titanium/40">
                  ...
                  <div className="lg:col-span-8 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-[11px] font-bold text-titanium/60 uppercase tracking-widest mb-2">الفئة</label>
                        <div className="relative">
                          <select 
                            required
                            value={formData.category}
                            onChange={(e) => setFormData({...formData, category: e.target.value})}
                            className="w-full px-4 py-3 rounded-xl bg-carbon/5 border border-titanium/10 focus:ring-2 focus:ring-solar/20 focus:border-solar outline-none transition-all font-bold text-carbon text-sm appearance-none pr-10"
                          >
                      ...
                      <div>
                        <label className="block text-[11px] font-bold text-titanium/60 uppercase tracking-widest mb-2">حالة المنتج</label>
                        <div className="relative">
                          <select 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-[11px] font-bold text-titanium/60 uppercase tracking-widest mb-2">الألوان المتوفرة</label>
                        ...
                        <div className="flex flex-wrap gap-2 mb-3 min-h-[32px]">
                          {formData.colors?.map((color, index) => {
                            ...
                            return (
                              <div key={index} className="flex items-center gap-1.5 bg-carbon/5 border border-titanium/10 px-2.5 py-1 rounded-full text-xs font-bold text-carbon">
                                {knownColor && (
                                  <span className="w-2.5 h-2.5 rounded-full border border-titanium/10 shadow-sm" style={{ backgroundColor: knownColor.value }} />
                                )}
                                {!knownColor && typeof color === 'string' && color.startsWith('#') && (
                                  <span className="w-2.5 h-2.5 rounded-full border border-titanium/10 shadow-sm" style={{ backgroundColor: color }} />
                                )}
                                <span>{knownColor ? knownColor.name : color}</span>
                                <button 
                                  type="button"
                                  onClick={() => setFormData({...formData, colors: formData.colors?.filter((_, i) => i !== index)})}
                                  className="text-titanium/40 hover:text-red-500 transition-colors ml-1"
                                >
                                  <X className="w-3 h-3" />
                                </button>
                              </div>
                          ...
                          {(!formData.colors || formData.colors.length === 0) && (
                            <span className="text-xs text-titanium/40 font-medium py-1">لم يتم اختيار ألوان</span>
                          )}
                        </div>
                        
                        {/* Color Picker Palette */}
                        <div className="flex flex-wrap gap-2 mb-3 p-3 bg-carbon/5 rounded-xl border border-titanium/10">
                        ...
                        <div className="flex gap-2">
                          <input 
                            type="text" 
                            id="customColorInput"
                            className="flex-1 px-4 py-2.5 rounded-xl bg-carbon/5 border border-titanium/10 focus:ring-2 focus:ring-solar/20 focus:border-solar outline-none transition-all font-bold text-carbon text-sm"
                      ...
                      <div>
                        <label className="block text-[11px] font-bold text-titanium/60 uppercase tracking-widest mb-2">الأحجام / المقاسات</label>
                        
                        {/* Display existing sizes as tags */}
                        <div className="flex flex-wrap gap-2 mb-3 min-h-[32px]">
                          {formData.sizes?.map((size, index) => (
                            <span key={index} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-carbon/5 text-carbon text-sm font-bold border border-titanium/10">
                              {size}
                              <button
                                type="button"
                                onClick={() => {
                                ...
                                className="text-titanium/40 hover:text-red-500 transition-colors"
                              >
                          ...
                          {(!formData.sizes || formData.sizes.length === 0) && (
                            <span className="text-xs text-titanium/40 font-medium py-1">لم يتم إضافة مقاسات</span>
                          )}
                        </div>
                    ...
                    <div>
                      <label className="block text-[11px] font-bold text-titanium/60 uppercase tracking-widest mb-2">المواصفات التقنية</label>
                      <div className="space-y-3 bg-carbon/5 p-4 rounded-xl border border-titanium/10">
                        {Object.entries(formData.specs || {}).length > 0 && (
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-3">
                            {Object.entries(formData.specs || {}).map(([key, value]) => (
                              <div key={key} className="flex items-center justify-between bg-white p-2 px-3 rounded-lg border border-titanium/5 shadow-sm">
                                <div className="flex items-center gap-2 text-sm">
                                  <span className="font-bold text-carbon">{key}:</span>
                                  <span className="text-titanium/60">{value}</span>
                                </div>
                                <button 
                                  type="button" 
                                  onClick={() => {
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                          <input 
                            ...
                            className="flex-1 px-3 py-2 rounded-lg bg-white border border-titanium/10 focus:ring-2 focus:ring-solar/20 focus:border-solar outline-none transition-all text-sm"
                          />
                          <input 
                            id="new-spec-value" 
                            type="text"
                    ...
                    <div>
                      <label className="block text-[11px] font-bold text-titanium/60 uppercase tracking-widest mb-2">الوصف (اختياري)</label>
                      <textarea 
                        rows={3}
                        value={formData.description}
                        onChange={(e) => setFormData({...formData, description: e.target.value})}
                        className="w-full px-4 py-3 rounded-xl bg-carbon/5 border border-titanium/10 focus:ring-2 focus:ring-solar/20 focus:border-solar outline-none transition-all font-bold text-carbon text-sm resize-none"
              ...
              {/* Modal Footer */}
              <div className="p-6 border-t border-titanium/5 bg-carbon/5 flex justify-end gap-3">
                <button 
                  type="button"
                  onClick={handleCloseModal}
                  className="px-6 py-3 rounded-xl font-black text-titanium/60 hover:bg-carbon/10 transition-all text-xs uppercase tracking-widest"
                >
                  إلغاء
                </button>
                <button 

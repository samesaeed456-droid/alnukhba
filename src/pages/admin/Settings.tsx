...
const Settings = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      shortLabel: "تنبيهات",
      icon: Bell,
      description: "إدارة الإشعارات والرسائل",
    },
    {
      id: "seo",
      label: "إعدادات SEO",
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500 mt-0.5">
                            إرسال إشعارات للعملاء عند تغيير حالة الطلب
                          </p>
                        </div>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        >
                          ...
                          <div className="space-y-3">
                            <label className="text-sm font-bold text-slate-700">
                              إرسال تنبيه عند الحالات التالية:
                            </label>
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                              {[
                                {
                                  id: "pending",
                                  label: "قيد الانتظار (طلب جديد)",
                                },
                                ...
                                <label
                                  key={status.id}
                                  className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-100 cursor-pointer hover:border-solar/30 transition-all"
                                >
                                  <input
                                    type="checkbox"
                                    className="w-4 h-4 rounded border-slate-300 text-solar focus:ring-solar"
                                    checked={formData.autoNotifications?.onStatusChange.includes(
                                      status.id as any,
                                    )}
                                    onChange={(e) => {
                                      const current =
                  ...
                  <div className="bg-blue-50 border border-blue-100 p-4 rounded-2xl flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-700 mt-0.5">
                        يتم إرسال الرسائل تلقائياً بناءً على القوالب المحددة
                        مسبقاً لكل حالة طلب لضمان بقاء العميل على اطلاع دائم.
                      </p>
                    </div>
                  </div>
                </div>
